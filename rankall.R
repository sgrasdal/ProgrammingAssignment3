# Question 3
##Finding the hospital ranking overall
library(tidyverse)
library(data.table)
...
rankall <- function(outcome, num = "best") {
        ...
        # Read outcome data
        out_dt <- data.table::fread("~/School/WNTR 2024/R Programming/Week 4/rprog_data_ProgAssignment3-data/outcome-of-care-measures.csv")
